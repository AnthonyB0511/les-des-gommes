                ...
                <section className="d-flex align-center">
                    ...
                    <article>
                        <section className="d-flex align-items-center">
                            ...
                            <i className={`fa-solid fa-rectangle-xmark mr20 ${styles.no}`} onClick={() => modifyMessage({ ...message, edit: false })}></i>
                            {message.report !== 1 && <i className={`fa-solid fa-circle-exclamation ${styles.no}`} onClick={() => alertMessage(message)}></i>}
                            {(message.report === 1 && user.role === 'admin') && <i className={`fa-solid fa-check-to-slot ${styles.ok}`} onClick={() => modifyMessage({ ...message, report: 0 })}></i>}
